package org.example.book.search;
...
public class PdfGenerator {
    public static void generateBookListPdf(List<Book> books, String fileName) throws FileNotFoundException {
        ...
        for (Book book : books) {
            table.addCell(createCell(book.getTitle(), true));
            table.addCell(createCell(book.getAuthors(), true));
            table.addCell(createCell(book.getPublisher(), true));
